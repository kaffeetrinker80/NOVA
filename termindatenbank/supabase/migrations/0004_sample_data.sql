...
insert into nova_termindatenbank_data.td_kunden (id, name_lang, name_kurz, typ, strasse, plz, ort, telefon, email, legacy_quelle) values
...
insert into nova_termindatenbank_data.td_anlagen (id, kunde_id, name, strasse, plz, ort, turnus_monate, naechste_untersuchung, legacy_quelle) values
...
insert into nova_termindatenbank_data.td_bereiche (id, anlage_id, name, beschreibung, legacy_quelle) values
...
insert into nova_termindatenbank_data.td_termine (id, kunde_id, anlage_id, datum, beginn, ende, status, legacy_quelle) values
...
insert into nova_termindatenbank_data.td_auftragsnummern_zaehler (jahr, letzter_wert) values (2026, 898)
  on conflict (jahr) do update set letzter_wert = greatest(nova_termindatenbank_data.td_auftragsnummern_zaehler.letzter_wert, 898);

insert into nova_termindatenbank_data.td_auftraege (id, auftragsnummer, jahr, bereich_id, termin_id, legacy_quelle) values
...
insert into nova_termindatenbank_data.td_unterauftraege (auftrag_id, suffix, art, umfang, proben_geplant) values
